...
/**
 * Monkey-patched GenerateSwaggerCode to use ExecOperations instead of project.javaexec,
 * which has been removed with gradle 9.0.
 * TODO: Remove this when 'org.hidetake.gradle.swagger.generator' is updated/replaced.
 */
@Slf4j
@CacheableTask
abstract class GenerateSwaggerCode extends DefaultTask {
    ...
    void exec() {
        ...
        // }
        getExecOperations().javaexec { JavaExecSpec c ->
            c.classpath(javaExecOptions.classpath)
            c.mainClass = javaExecOptions.main
            c.args = javaExecOptions.args
            c.systemProperties(javaExecOptions.systemProperties)
